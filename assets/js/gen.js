...
var cookie_toggle = document.getElementById("cookie_settings");
var consent_analytics = document.getElementById("consent-analytics");
var consent_chat = document.getElementById("consent-chat");
cookie_toggle.addEventListener('click', function () {
    if (cookie_banner.classList.contains("show")) {
        ...
        if (consent) {
            consent_analytics.checked = consent.analytics ?? false;
            consent_chat.checked = consent.chat ?? false;
        }
...
function loadTawkto() {
    if (typeof tawkTo != 'undefined' && tawkTo == false) {
        return;
    }
    tawktoApp();
}
...
function saveConsent() {
    const consent = {
        analytics: consent_analytics.checked,
        chat: consent_chat.checked
    };
